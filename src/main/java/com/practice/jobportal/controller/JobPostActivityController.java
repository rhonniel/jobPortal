...
import com.practice.jobportal.services.JobSeekerApplyService;
import com.practice.jobportal.services.JobSeekerSaveService;
    ...
    public String searchJobs(Model model, @RequestParam(value = "job", required = false) String job,
        ...
        if(!(authentication instanceof AnonymousAuthenticationToken)){
            ...
            if(authentication.getAuthorities().contains( new SimpleGrantedAuthority("Recruiter"))){
               ...
               List<JobSeekerApply> jobSeekerApplies=  jobSeekerApplyService.getCandidateJobs((JobSeekerProfile) currentUserProfile);
               List<JobSeekerSave> jobSeekerSaves= jobSeekerSaveService.getCandidatesJob((JobSeekerProfile) currentUserProfile);
